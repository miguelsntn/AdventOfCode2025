...
import software.aoc.day06.a.HorizontalExpressionScanner;
...
public class Day06ATest {
    ...
    @Test
    public void should_calculate_grand_total_correctly_for_horizontal_reading() {
        List<String> lines = EXAMPLE_INPUT.lines().toList();
        ExpressionScanner scanner = new HorizontalExpressionScanner();
