...
import software.aoc.day07.a.TachyonManifold;
...
public class Day07ATest {
    ...
    public static void main(String[] args) {
        ...
        try (Stream<String> lines = Files.lines(inputPath)) {
            ...
            long splits = manifold.countTotalSplits();

            System.out.println("El numero total de veces que el rayo se divide es: " + splits);
